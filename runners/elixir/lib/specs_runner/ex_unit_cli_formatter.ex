defmodule SpecsRunner.ExUnitCLIFormatter do
  @moduledoc """
  Copy-pasted from ExUnit.CLIFormatter and adapted to use RunInfo to match specs
  """
  use GenServer
  ...
  defp test_name(%ExUnit.Test{name: name}, scenario) do
    name
    |> to_string()
